...
// configure
$from = 'info@nickscala.com'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'nick.scala@me.com'; // Replace it with Your email. REQUIRED!
...
if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
    ...
    $secret = '6LdilCkaAAAAAL4fz0hl5Rv_mDEAdiYiIAzWER8D';
