	...
	$("#form-contact").ajaxForm({
		...
		success: function(msg){
			$("#form-message").ajaxComplete(function(event, request, settings){
				...
				{
					result = '<span class="form-message-success"><i class="fa fa-thumbs-up" aria-hidden="true"></i> Your message was sent. Thank you!</span>';
					clear = true;
				}
				else
				{
					result = '<span class="form-message-error"><i class="fa fa-thumbs-down" aria-hidden="true"></i> ' + msg +'</span>';
					clear = false;
				}
				$(this).html(result);
